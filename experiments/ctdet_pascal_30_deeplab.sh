cd src
# train
CUDA_VISIBLE_DEVICES=2 python main.py ctdet --exp_id pascal_resnet101_original_hm_loss_change_wh_test --arch resdcn_101 --multi_res --dataset pascal --input_res 512 --batch_size 32 --num_epochs 70  --lr_step 30,45,55 --gpus 1
# test
