cd src
# train
CUDA_VISIBLE_DEVICES=0 python main.py fadet --exp_id wider_hrnet_whmulti --arch hrnet_18 --batch_size 5 --lr 1e-3 --lr_step 15,25,35,45,55,65 --gpus 0 --num_workers 4 --dataset wider
