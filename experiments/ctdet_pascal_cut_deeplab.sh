cd src
# train
CUDA_VISIBLE_DEVICES=2 python main.py ctdet --exp_id pascal_deeplab_multi_resnet101_512_change_lr --arch deeplab_resnet101 --multi_res --dataset pascal --input_res 512 --batch_size 32 --num_epochs 70 --lr_step 45,60 --gpus 1
# test
