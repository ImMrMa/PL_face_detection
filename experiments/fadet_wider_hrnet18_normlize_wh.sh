cd src
# train
CUDA_VISIBLE_DEVICES=0 python main.py fadet --exp_id wider_hrnet_norm_wh_noreg --arch hrnet_18 --batch_size 5 --wh_weight=1 --not_reg_offset --lr 5e-4 --lr_step 15,25,35,45,55,65 --gpus 0 --num_workers 4 --dataset wider
