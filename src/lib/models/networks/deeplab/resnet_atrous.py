...
# from models.sync_BatchNoorm import nn.BatchNorm2d
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, atrous=1, downsample=None):
        ...
        #self.bn1 = nn.BatchNoorm2d(planes)
        self.bn1 = nn.BatchNorm2d(planes)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
        #self.bn2 = nn.BatchNoorm2d(planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, atrous=1, downsample=None):
        ...
        # self.bn3 = nn.BatchNoorm2d(planes * self.expansion)
